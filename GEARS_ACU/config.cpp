...
class cfgWeapons
{
	...
	class gear_ACU_kit01: Uniform_Base
	{
        ...
        hiddenSelections[] = {"Camo"};
        hiddenSelectionsTextures[] = {"\GEARS_CORE\clothing\common\data\suitpack_ACU.paa"};
   ...
   class gear_patrolcap_ACU_02: ItemCore
   	...
   	class gear_cover_ACU_01: ItemCore
	{
   	...
   	class gear_ach_ACU_00: H_HelmetB
	{
		scope = 2;
		author = "KetsuCorp";
		weaponPoolAvailable = 1;
		displayName = "U.S. ACU MICH 2000, 01A";
		picture = "\GEARS_CORE\ui\ACU_ui.paa";
   	...
   	class gear_ach_ACU_01: H_HelmetB
	{
		...
		author = "KetsuCorp";
		weaponPoolAvailable = 1;
		displayName = "U.S. ACU MICH 2000, 01B";
		picture = "\GEARS_CORE\ui\ACU_ui.paa";
		model = "\GEARS_CORE\headwear\common\gear_ach_CORE_07";
		hiddenSelections[] = {"Camo","Camo1"};
		hiddenSelectionsTextures[] = {"\GEARS_ACU\helmets\ACH\ACU\data\ACH_ACU_01_co.paa","\GEARS_ACU\helmets\ACH\ACU\data\ACH_ACU_02_co.paa"};
		class ItemInfo: HeadGearItem
		{	
		    ...
		    mass = 1;
			uniformModel = "\GEARS_CORE\headwear\common\gear_ach_CORE_07";
			armor = 5;
			passthrough = 0.610;
		    hiddenSelections[] = {"Camo","Camo1"};
	    };
